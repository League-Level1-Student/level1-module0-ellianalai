...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		if (guess.equals("arnold")) {
			...
			JOptionPane.showMessageDialog(panel, "Sorry, you are wrong");
		}
		showNextImage();
		JOptionPane.showMessageDialog(panel, "Your current score is " + score);
		}
		JOptionPane.showMessageDialog(panel,"You got " + score + " points");
		// 6. Otherwise:
